...
<CenterTitle number="2" subtitle="最常被誤用的記憶化 (Memoization)">
...
<!--
但有些情況，光靠狀態下移還不夠，所以這一章我們要來聊聊 React 中很常被誤用的記憶化 (Memoization)，
...
後端 API 好了，需要在進入頁面時去 fetch 使用者資料，並帶一些參數記錄進入頁面的時間
